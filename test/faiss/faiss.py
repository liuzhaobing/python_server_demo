...
def qqsim_interface(questions: list):
    ...
    response = qqsim(text_pair)  # 访问qqsim接口获取结果
...
if __name__ == '__main__':
    resolve = {
        "positive": {
            "filename": r"D:\Gitee\python_server_demo\data\user_qa\yuanyao_testcase.xlsx",
            "sheet_name": "positive"
        },
        "negative": {
            "filename": r"D:\Gitee\python_server_demo\data\user_qa\yuanyao_testcase.xlsx",
    ...
    for key, value in resolve.items():
        ...
        util.save_data_to_xlsx(query_to_faiss_and_qqsim_and_es(cases), f"./query_to_faiss_and_qqsim_and_es_{key}.xlsx")
